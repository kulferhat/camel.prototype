...
public class SetBodyDialog extends JDialog {

	private final JPanel contentPanel = new JPanel();
	private JTextArea txtExpression;
	private JComboBox comboBoxExpressionType;
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						route.addRouteNode(new SetBodyNode(txtExpression.getText(), ExpressionBuilder.ExpressionType.valueOf((String)comboBoxExpressionType.getSelectedItem())));
