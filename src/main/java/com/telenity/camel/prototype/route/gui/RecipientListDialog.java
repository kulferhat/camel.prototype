...
import com.telenity.camel.prototype.route.nodedef.impl.RecipientListNode;

import java.awt.event.ActionListener;
import java.awt.event.ActionEvent;

public class RecipientListDialog extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RecipientListDialog dialog = new RecipientListDialog();
	 ...
	 * Create the dialog.
	 */
	public RecipientListDialog() {
		setTitle("RecipientList");
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						route.addRouteNode(new RecipientListNode(txtUri.getText()));
